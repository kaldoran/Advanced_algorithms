...
\section{Algorithmes de résolution de problème du voyageur de commerce}
	...
	\subsubsection{Approche génétique}
		...
		Pour avoir de meilleurs résultat sur des graphes posédant un plus grand nombre de noeud, il faudrait augmenter le nombre de solution générées au départ 
